...
const code = `@Controller('contacts')
...
const tabs = [
  { name: 'contacts.controller.ts', isActive: true },
  { name: 'Contacts/Index.tsx', isActive: false },
]
      ...
      <div className="py-16 sm:px-2 lg:relative lg:px-0 lg:py-20">
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 lg:max-w-8xl lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">
          <div className="relative z-10 md:text-center lg:text-left">
            <img className="absolute right-full bottom-full -mr-72 -mb-56 opacity-50" src={blurCyanImage} alt="" width={530} height={530} />
          ...
          <div className="relative lg:static xl:pl-10">
            ...
            <div className="relative">
              <img className="absolute -top-64 -right-64" src={blurCyanImage} alt="" width={530} height={530} />
              <img className="absolute -right-44 -bottom-40" src={blurIndigoImage} alt="" width={567} height={567} />
              ...
              <div className="relative rounded-2xl bg-[#0A101F]/80 ring-1 ring-white/10 backdrop-blur-sm">
                ...
                <div className="pt-4 pl-4">
                  ...
                  <div className="mt-6 flex items-start px-1 text-sm">
                    <div aria-hidden="true" className="border-r border-slate-300/5 pr-4 font-mono text-slate-600 select-none">
                    ...
                    <Highlight code={code} language="typescript" theme={{ plain: {}, styles: [] }}>
